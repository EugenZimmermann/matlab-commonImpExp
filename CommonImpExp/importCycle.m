function imp = importCycle(folder,filename)
% import IV data of new setup (*.iv*)
% This function imports IV data into struct imp.
...
% Last Modified on 2015-10-25
    ...
    fid = fopen([folder,'/',filename],'r');
        ...
        try
            ...
            data = textscan(fid,'%f %f %f','delimiter', '\t','HeaderLines',2,'MultipleDelimsAsOne',1,'CollectOutput',1);
        catch e
            disp(e.message)
            return;
        end
